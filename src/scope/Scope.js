...
class $RootScopeProvider {
    constructor() {
        ...
        function rootScopeFactory($parse) {
            class Scope {
                constructor() {
                    this.$root = this;
                    this.$$watchers = [];
                ...
                $watchCollection(watchFn, listener) {
                    ...
                    var internalListener = ()=> {
                        ...
                        if (trackVeryOldValue) {
                            veryOldValue = _.cloneDeep(newValues);
                        }
                    };
        ...
        rootScopeFactory.$inject = ['$parse'];
        this.digestTtl = function (ttl) {
            if(_.isNumber(ttl)){
                TTL = ttl;
            }
        };
        this.$get = rootScopeFactory;
    }
}
var areEqual = (newVal, oldVal, valueEq)=> {
    if (valueEq) {
        return _.eq(newVal, oldVal);
    }
