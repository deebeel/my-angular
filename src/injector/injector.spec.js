...
describe('injector', ()=> {
    var injector, module, core;
    beforeEach(()=> {
        core = new Core();
        module = core.module('myModule', []);
        injector = null;
    });
    ...
    it('has a constant that has been registered to a module', function () {
        ...
        injector = createInjector(['myModule'], core);
        expect(injector.has('aConstant')).toBe(true);
    });
    it('does not have a non-registered constant', function () {
        var injector = createInjector(['myModule'], core);
        expect(injector.has('aConstant')).toBe(false);
    });
    it('does not allow a constant called hasOwnProperty', function () {
        module.constant('hasOwnProperty', _.constant(false));
        expect(function () {
            createInjector(['myModule'], core);
        }).toThrow();
    });
    ...
    it('loads multiple modules', function () {
        var module1 = core.module('myModule', []);
        var module2 = core.module('myOtherModule', []);
        module1.constant('aConstant', 42);
        module2.constant('anotherConstant', 43);
        var injector = createInjector(['myModule', 'myOtherModule'], core);
        expect(injector.has('aConstant')).toBe(true);
        expect(injector.has('anotherConstant')).toBe(true);
    });
    it('loads the required modules of a module', function () {
        var module1 = core.module('myModule', []);
        var module2 = core.module('myOtherModule', ['myModule']);
        module1.constant('aConstant', 42);
        module2.constant('anotherConstant', 43);
        var injector = createInjector(['myOtherModule'], core);
        expect(injector.has('aConstant')).toBe(true);
        expect(injector.has('anotherConstant')).toBe(true);
    });
    ...
    it('loads the transitively required modules of a module', function () {
        var module1 = core.module('myModule', []);
        var module2 = core.module('myOtherModule', ['myModule']);
        var module3 = core.module('myThirdModule', ['myOtherModule']);
        module1.constant('aConstant', 42);
        module2.constant('anotherConstant', 43);
        module3.constant('aThirdConstant', 44);
        var injector = createInjector(['myThirdModule'], core);
        expect(injector.has('aConstant')).toBe(true);
        expect(injector.has('anotherConstant')).toBe(true);
        expect(injector.has('aThirdConstant')).toBe(true);
    });
    it('loads each module only once', function () {
        core.module('myModule1', ['myOtherModule']);
        core.module('myOtherModule', ['myModule1']);
        createInjector(['myModule1'], core);
    });
    ...
    it('instantiates a dependency only once', function () {
        var module = core.module('myModule', []);
        module.provider('a', {
            $get: function () {
                return {};
            }
    ...
    it('does not inject a provider to invoke', function () {
        ...
        }).toThrowError(/Unknown\sprovider/);
    });
    ...
    it('runs a config block added during module registration', function () {
        core.module('myModule1', [], function ($provide) {
            $provide.constant('a', 42);
        });
        var injector = createInjector(['myModule1'], core);
        expect(injector.get('a')).toBe(42);
    });
    ...
    it('configures all modules before running any run blocks', function () {
        ...
        createInjector(['myModule', 'myOtherModule'], core);
    ...
    it('runs a function module dependency as a config block', function () {
        ...
        core.module('myModule1', [functionModule]);
        var injector = createInjector(['myModule1'], core);
        expect(injector.get('a')).toBe(42);
    });
    ...
    it('only loads function modules once', function () {
        ...
        core.module('myModule1', [functionModule, functionModule]);
        createInjector(['myModule1'], core);
    ...
    it('filter can be registered through module API', function () {
...
describe('annotate', function () {
    ...
    it('throws when using a non-annotated fn in strict mode', function () {
        var injector = createInjector([], null, true);
        var fn = function (a, b, c) {
        };
        expect(function () {
